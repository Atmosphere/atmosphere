...
export function App() {
  ...
  const { fullText, isStreaming, progress, metadata, aiEvents, error, send, reset } =
  ...
  return (
    <ChatLayout
      title={<><img src="/logo.png" alt="" style={{ height: '1.2em', verticalAlign: 'middle', marginRight: 8 }} />Atmosphere + LangChain4j Tools</>}
      subtitle="Tool calling with PII redaction &amp; cost metering"
      theme="langchain4j"
    ...
    >
      ...
      <ChatInput
        onSend={handleSend}
        placeholder="Ask about time, weather, or try sending PII…"
