 ...
 * and registers Atmosphere AI broadcast filters for PII redaction and cost metering.
 */
@Configuration
public class LlmConfig {
    ...
    @Bean
    public BroadcastFilter piiRedactionFilter() {
        logger.info("Registering PII redaction filter");
        return new PiiRedactionFilter();
    }
