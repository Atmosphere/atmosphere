var count = 0;
var app = {
    url: '/atmosphere-guice-chat/chat',
    initialize: function() {
        $('login-name').focus();
        app.listen();
    },
    ...
    ping: function() {
        $('ping-button').disabled = true;
        $('ping-button').style.display = 'none';
        new Ajax.Request(app.url + '/ping');
    },
    login: function() {
...
var rules = {
    '#ping-button': function(elem) {
        elem.onclick = app.ping;
    },
