...
/**
 * Demonstrates Atmosphere 4.0 observability features with Spring Boot Actuator.
 *
 * <p>Metrics are available at {@code /actuator/metrics/atmosphere.*} and
 * health at {@code /actuator/health}.</p>
 */
@Configuration
