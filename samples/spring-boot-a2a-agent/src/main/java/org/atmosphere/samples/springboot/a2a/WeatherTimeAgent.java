...
@Agent(
    ...
    description = "AI-powered assistant that answers questions, provides weather info, and handles time queries."
            + " Uses Gemini/OpenAI/Ollama when configured, with built-in demo fallback.",
    version = "1.0.0",
...
public class WeatherTimeAgent {
    ...
    @AgentSkill(id = "get-weather", name = "Get Weather",
              description = "Get weather for a location. With LLM configured, provides AI-generated weather analysis."
                      + " Without, returns simulated data.",
    ...
    public void getTime(TaskContext task,
                        @AgentSkillParam(name = "timezone",
                                description = "IANA timezone (e.g., America/New_York, Europe/Paris, Asia/Tokyo)")
                        String timezone) {
