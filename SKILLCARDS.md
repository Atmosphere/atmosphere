...
|---------|--------|----------|--------------|------|---------------|-----------|
| `AdkAgentRuntime` | `modules/adk` | java | 17 | [card](modules/adk/SKILLCARD.yaml) | [test](modules/adk/src/test/java/org/atmosphere/ai/adk/AdkRuntimeContractTest.java) | unsigned |
...
| `AnthropicAgentRuntime` | `modules/anthropic` | java | 14 | [card](modules/anthropic/SKILLCARD.yaml) | [test](modules/anthropic/src/test/java/org/atmosphere/ai/anthropic/AnthropicRuntimeContractTest.java) | unsigned |
| `BuiltInAgentRuntime` | `modules/ai-test` | java | 17 | [card](modules/ai/SKILLCARD.yaml) | [test](modules/ai-test/src/test/java/org/atmosphere/ai/test/BuiltInRuntimeContractTest.java) | unsigned |
| `CohereAgentRuntime` | `modules/cohere` | java | 15 | [card](modules/cohere/SKILLCARD.yaml) | [test](modules/cohere/src/test/java/org/atmosphere/ai/cohere/CohereRuntimeContractTest.java) | unsigned |
...
| `LangChain4jAgentRuntime` | `modules/langchain4j` | java | 16 | [card](modules/langchain4j/SKILLCARD.yaml) | [test](modules/langchain4j/src/test/java/org/atmosphere/ai/langchain4j/LangChain4jRuntimeContractTest.java) | unsigned |
| `SemanticKernelAgentRuntime` | `modules/semantic-kernel` | java | 14 | [card](modules/semantic-kernel/SKILLCARD.yaml) | [test](modules/semantic-kernel/src/test/java/org/atmosphere/ai/sk/SemanticKernelRuntimeContractTest.java) | unsigned |
| `SpringAiAgentRuntime` | `modules/spring-ai` | java | 16 | [card](modules/spring-ai/SKILLCARD.yaml) | [test](modules/spring-ai/src/test/java/org/atmosphere/ai/spring/SpringAiRuntimeContractTest.java) | unsigned |
| `SpringAiAlibabaAgentRuntime` | `modules/spring-ai-alibaba` | java | 15 | [card](modules/spring-ai-alibaba/SKILLCARD.yaml) | [test](modules/spring-ai-alibaba/src/test/java/org/atmosphere/ai/spring/alibaba/SpringAiAlibabaRuntimeContractTest.java) | unsigned |
