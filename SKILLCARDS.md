...
| `EmbabelAgentRuntime` | `modules/embabel` | kotlin | 16 | [card](modules/embabel/SKILLCARD.yaml) | [test](modules/embabel/src/test/kotlin/org/atmosphere/ai/embabel/EmbabelRuntimeContractTest.kt) | unsigned |
