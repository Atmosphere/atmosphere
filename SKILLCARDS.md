...
|---------|--------|----------|--------------|------|---------------|-----------|
| `AdkAgentRuntime` | `modules/adk` | java | 18 | [card](modules/adk/SKILLCARD.yaml) | [test](modules/adk/src/test/java/org/atmosphere/ai/adk/AdkRuntimeContractTest.java) | unsigned |
| `AgentScopeAgentRuntime` | `modules/agentscope` | java | 16 | [card](modules/agentscope/SKILLCARD.yaml) | [test](modules/agentscope/src/test/java/org/atmosphere/ai/agentscope/AgentScopeRuntimeContractTest.java) | unsigned |
| `AnthropicAgentRuntime` | `modules/anthropic` | java | 15 | [card](modules/anthropic/SKILLCARD.yaml) | [test](modules/anthropic/src/test/java/org/atmosphere/ai/anthropic/AnthropicRuntimeContractTest.java) | unsigned |
