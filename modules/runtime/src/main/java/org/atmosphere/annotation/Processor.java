 ...
 * when the {@link org.atmosphere.runtime.AtmosphereFramework#init()} executes. Classes implementing this interface will
 * have a chance to process annotated classes and take the appropriate action.
 */
public interface Processor<T> {

    /**
     * Invoked by the {@link org.atmosphere.runtime.AnnotationHandler} when an annotation is detected.
     *
