...
import org.atmosphere.runtime.AtmosphereServletProcessor;
...
public abstract class AbstractReflectorAtmosphereHandler implements AtmosphereServletProcessor {
    ...
    /**
     * <p>
     * This default implementation does nothing when {@link #onRequest(org.atmosphere.runtime.AtmosphereResource)} is called.
     * It could be used when all the installed {@link org.atmosphere.runtime.AtmosphereInterceptor interceptors} do the job
