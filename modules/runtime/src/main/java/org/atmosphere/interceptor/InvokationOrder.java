...
/**
 * A simple marker class to use with {@link org.atmosphere.runtime.AtmosphereInterceptor} in order to determine in which
 * position in the interceptor's chain the AtmosphereInterceptor must be installed.
 * <p/>
 * Normally all {@link org.atmosphere.runtime.AtmosphereInterceptor} are installed using the {@link InvokationOrder.PRIORITY#AFTER_DEFAULT}
 *
...
public interface InvokationOrder {
    ...
    enum PRIORITY {
         ...
         * add one instance per {@link org.atmosphere.runtime.AtmosphereInterceptor}
         */
        BEFORE_DEFAULT,
        /**
