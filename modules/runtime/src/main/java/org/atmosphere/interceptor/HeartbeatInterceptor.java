...
import org.atmosphere.runtime.HeartbeatAtmosphereResourceEvent;
...
import static org.atmosphere.runtime.ApplicationConfig.CLIENT_HEARTBEAT_INTERVAL_IN_SECONDS;
import static org.atmosphere.runtime.ApplicationConfig.FLUSH_BUFFER_HEARTBEAT;
import static org.atmosphere.runtime.ApplicationConfig.HEARTBEAT_INTERVAL_IN_SECONDS;
import static org.atmosphere.runtime.ApplicationConfig.HEARTBEAT_PADDING_CHAR;
import static org.atmosphere.runtime.ApplicationConfig.RESUME_ON_HEARTBEAT;

/**
 * <p>
 * An interceptor that send whitespace every in 60 seconds by default. Another value could be specified with the
 * {@link org.atmosphere.runtime.ApplicationConfig#HEARTBEAT_INTERVAL_IN_SECONDS} in the atmosphere config. The heartbeat will be scheduled as soon as the
