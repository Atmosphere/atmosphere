...
import static org.atmosphere.runtime.ApplicationConfig.EXCLUDED_CONTENT_TYPES;
import static org.atmosphere.runtime.ApplicationConfig.MESSAGE_DELIMITER;

/**
 * An {@link org.atmosphere.runtime.AtmosphereInterceptor} that add a message size and delimiter.
 * <p/>
 * The special String is configurable using {@link org.atmosphere.runtime.ApplicationConfig#MESSAGE_DELIMITER} and
