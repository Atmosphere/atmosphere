...
public interface BroadcasterListener {
    ...
    /**
     * Invoked when the Broadcast operation completes for all {@link org.atmosphere.runtime.AtmosphereResource}.
     *
     * @param b a Broadcaster
     */
    ...
    /**
     * Throw this exception to interrupt the {@link org.atmosphere.runtime.Broadcaster#destroy()} operation.
     */
