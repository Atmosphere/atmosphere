 ...
 * so when {@link #broadcast(java.lang.Object)} is executed, {@link AtmosphereHandler#onStateChange(org.atmosphere.runtime.AtmosphereResourceEvent)}
 ...
 * {@link org.atmosphere.runtime.Broadcaster#broadcast(Object)} will be executed <strong>asynchronously</strong> so this is
 ...
 * {@link Broadcaster#setScope(org.atmosphere.runtime.Broadcaster.SCOPE)} ):<ul>
...
public interface Broadcaster {
     ...
     * resume {@link AtmosphereResource} using {@link org.atmosphere.runtime.Broadcaster.POLICY#FIFO} (first in first out)
     * or {@link org.atmosphere.runtime.Broadcaster.POLICY#REJECT} the {@link AtmosphereResource}.
     * <p/>
     * By default the number is unlimited.
     *
     * @param maxSuspended maximum number of suspended AtmosphereResource
     * @oaram policy the {@link org.atmosphere.runtime.Broadcaster.POLICY}
     */
     ...
     * {@link org.atmosphere.runtime.AtmosphereResource#resume()}.
     *
     * @param o the {@link Object} to be broadcasted
     * @return a {@link Future} that can be used to synchronize using the {@link Future#get()}
     */
     ...
     * @see org.atmosphere.runtime.Broadcaster#addAtmosphereResource(AtmosphereResource)
     */
    ...
    /**
     * Set the {@link org.atmosphere.runtime.BroadcasterLifeCyclePolicy}. Make sure you are selecting the right policy
     * to avoid unexpected situations.
     *
     * @param policy a {@link org.atmosphere.runtime.BroadcasterLifeCyclePolicy}
     */
    public void setBroadcasterLifeCyclePolicy(BroadcasterLifeCyclePolicy policy);

    /**
     * Get the {@link org.atmosphere.runtime.BroadcasterLifeCyclePolicy}.
     *
     * @return {@link org.atmosphere.runtime.BroadcasterLifeCyclePolicy}
     */
