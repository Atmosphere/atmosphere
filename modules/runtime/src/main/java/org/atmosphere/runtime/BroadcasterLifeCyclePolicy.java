...
/**
 * This class can be used to configure the life cycle of a {@link org.atmosphere.runtime.Broadcaster}, eg. when a broadcaster
 * gets destroyed {@link org.atmosphere.runtime.Broadcaster#destroy()} or when its associated resources
...
public class BroadcasterLifeCyclePolicy {
    ...
    public enum ATMOSPHERE_RESOURCE_POLICY {
         ...
         * {@link org.atmosphere.runtime.Broadcaster#releaseExternalResources()} will be invoked.
         */
        IDLE,

        /**
         * Release all resources associated with the Broadcaster when the idle time expires and destroy the Broadcaster.
         * This operation removes the Broadcaster from it's associated {@link org.atmosphere.runtime.BroadcasterFactory}
         * {@link org.atmosphere.runtime.Broadcaster#destroy()} will be invoked. Suspended {@link AtmosphereResource}
         * will NOT get resumed.
         */
        IDLE_DESTROY,
        ...
        /**
         * If there is no {@link org.atmosphere.runtime.AtmosphereResource} associated with the Broadcaster,
         * release all resources.
         * {@link org.atmosphere.runtime.Broadcaster#releaseExternalResources()} will be invoked.
         */
        EMPTY,
        /**
         * If there is no {@link org.atmosphere.runtime.AtmosphereResource} associated with the Broadcaster, release all resources,
         * and destroy the broadcaster. This operation removes the Broadcaster from its associated {@link org.atmosphere.runtime.BroadcasterFactory}
         * {@link org.atmosphere.runtime.Broadcaster#destroy()} will be invoked
         */
        EMPTY_DESTROY,

        /**
         * Never release or destroy the {@link org.atmosphere.runtime.Broadcaster}.
         */
        NEVER
