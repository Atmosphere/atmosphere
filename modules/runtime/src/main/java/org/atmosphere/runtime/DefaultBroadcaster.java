...
import org.atmosphere.runtime.BroadcastFilter.BroadcastAction;
...
import static org.atmosphere.runtime.ApplicationConfig.BROADCASTER_CACHE_STRATEGY;
...
import static org.atmosphere.runtime.ApplicationConfig.CACHE_MESSAGE_ON_IO_FLUSH_EXCEPTION;
import static org.atmosphere.runtime.ApplicationConfig.MAX_INACTIVE;
import static org.atmosphere.runtime.ApplicationConfig.OUT_OF_ORDER_BROADCAST;
import static org.atmosphere.runtime.ApplicationConfig.SUSPENDED_ATMOSPHERE_RESOURCE_UUID;
import static org.atmosphere.runtime.ApplicationConfig.WRITE_TIMEOUT;
import static org.atmosphere.runtime.BroadcasterLifeCyclePolicy.ATMOSPHERE_RESOURCE_POLICY.NEVER;
...
public class DefaultBroadcaster implements Broadcaster {
    ...
    /**
     * Rename this Broadcaster without invoking it's associated {@link org.atmosphere.runtime.BroadcasterFactory}. This
     * method must be carefully used as it could easily create memory leak as the Broadcaster won't be removed
     * from its {@link org.atmosphere.runtime.BroadcasterFactory}.
     *
