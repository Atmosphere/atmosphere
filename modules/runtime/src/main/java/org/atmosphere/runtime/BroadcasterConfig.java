...
public class BroadcasterConfig {
     ...
     *                         It means Atmosphere will NOT invoke the shutdown method when {@link org.atmosphere.runtime.BroadcasterConfig#destroy()}
     *                         is invoked.
     */
     ...
     * {@link org.atmosphere.runtime.AtmosphereResourceEvent#getMessage()}. By default, the result of {@link ExecutorsFactory#getAsyncOperationExecutor(AtmosphereConfig, String)}
     * is used if this method is not invoked.
     *
     ...
     *                              It means Atmosphere will NOT invoke the shutdown method when this {@link org.atmosphere.runtime.BroadcasterConfig#destroy()}
     *                              is invoked.
     */
    ...
    /**
     * Manipulate the message before and after they are getting filtered by {@link org.atmosphere.runtime.BroadcastFilter}
     */
