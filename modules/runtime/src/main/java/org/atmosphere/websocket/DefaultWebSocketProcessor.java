...
import org.atmosphere.runtime.AtmosphereResponseImpl;
...
import static org.atmosphere.runtime.Action.TYPE.SKIP_ATMOSPHEREHANDLER;
import static org.atmosphere.runtime.ApplicationConfig.INVOKE_ATMOSPHERE_INTERCEPTOR_ON_WEBSOCKET_MESSAGE;
import static org.atmosphere.runtime.ApplicationConfig.IN_MEMORY_STREAMING_BUFFER_SIZE;
import static org.atmosphere.runtime.ApplicationConfig.RECYCLE_ATMOSPHERE_REQUEST_RESPONSE;
import static org.atmosphere.runtime.ApplicationConfig.SUSPENDED_ATMOSPHERE_RESOURCE_UUID;
import static org.atmosphere.runtime.ApplicationConfig.WEBSOCKET_PROTOCOL_EXECUTION;
import static org.atmosphere.runtime.AtmosphereFramework.REFLECTOR_ATMOSPHEREHANDLER;
...
/**
 * Like the {@link org.atmosphere.runtime.AsynchronousProcessor} class, this class is responsible for dispatching WebSocket request to the
...
public class DefaultWebSocketProcessor implements WebSocketProcessor, Serializable, WebSocketPingPongListener {
    ...
    /**
     * Dispatch to request/response to the {@link org.atmosphere.runtime.AsyncSupport} implementation as it was a normal HTTP request.
     *
