...
import org.atmosphere.runtime.DefaultBroadcasterFactory;
...
import static org.atmosphere.runtime.ApplicationConfig.POOLEABLE_PROVIDER;
import static org.atmosphere.runtime.ApplicationConfig.SUPPORT_TRACKED_BROADCASTER;
 ...
 * with was already created under that name. Set {@link #trackPooledBroadcaster(boolean)} or {@link org.atmosphere.runtime.ApplicationConfig#SUPPORT_TRACKED_BROADCASTER} to true to track duplication but
 * be aware it can significantly reduce performance. Use the {@link org.atmosphere.runtime.DefaultBroadcasterFactory} is recommended
 * under that scenario.
 * <p></p>
 * By default, this factory doesn't keep trace of created Broadcasters hence a new pooled Broadcaster will always
 * be returned unless {@link #trackPooledBroadcaster(boolean)} or {@link org.atmosphere.runtime.ApplicationConfig#SUPPORT_TRACKED_BROADCASTER}
 * is set to true.
 * <p/>
...
public class PoolableBroadcasterFactory extends DefaultBroadcasterFactory {
    ...
    /**
     * Set to true to enable tracking of {@link org.atmosphere.runtime.Broadcaster#getID()} duplication. Enabling this
     * feature will significantly reduce the performance of the {@link org.atmosphere.pool.PoolableProvider}. Use the
     * {@link org.atmosphere.runtime.DefaultBroadcasterFactory} if you need to track's duplication.
     *
