...
/**
 * Pins the Spring bridge of the harness preset: the
 ...
 * {@code true} still works without the preset). Exclude-paths and the
 * compaction / prompt-cache seams bridge whenever set, independent of the
 * switch, because they matter under the unset default too.
 */
