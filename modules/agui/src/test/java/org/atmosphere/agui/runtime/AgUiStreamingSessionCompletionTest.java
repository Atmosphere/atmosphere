...
/**
 * Mirrors {@link ResourceAgUiSessionCompletionTest} for the public
 * {@link AgUiStreamingSession} decorator (Mode Parity: both AG-UI session
 * variants must produce identical terminal sequences):
 *
 * <ul>
 ...
 * </ul>
 */
class AgUiStreamingSessionCompletionTest {
    ...
    void setUp() throws Exception {
        ...
        session = new AgUiStreamingSession(new StubSession(), response, runContext);
    }
    ...
    /** Minimal delegate — the decorator forwards lifecycle calls to it. */
