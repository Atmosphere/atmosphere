...
class AtmosphereAiEndpointRegistrar {
    ...
    AtmosphereAiEndpointRegistrar(AtmosphereFramework framework,
        ...
        // Merge Spring-supplied guardrail beans with any registered via the
        // ServiceLoader SPI (deduped by concrete type) so plain-servlet /
        // Quarkus-native classpaths pick up guardrails too — Spring beans win
        // ties (added first).
