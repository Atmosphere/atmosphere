...
/**
 * A minimal MCP server agent used by {@link McpQuarkusAuthTest} to prove an
 * {@code @Agent} registers an MCP endpoint (and its OAuth gate) under Quarkus.
 */
@Agent(name = "quarkus-mcp-test", version = "1.0.0", endpoint = "/atmosphere/mcp", headless = true)
public class EchoMcpAgent {
