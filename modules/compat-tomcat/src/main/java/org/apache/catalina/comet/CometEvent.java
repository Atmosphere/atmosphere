...
public interface CometEvent {
     ...
     * @throws java.io.IOException An IOException may be thrown to indicate an IO error,
     *         or that the EOF has been reached on the connection
     * @throws javax.servlet.ServletException An exception has occurred, as specified by the root
     *         cause
