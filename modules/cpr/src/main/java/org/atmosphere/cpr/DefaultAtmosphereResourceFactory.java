...
public class DefaultAtmosphereResourceFactory extends AtmosphereResourceFactory {
    ...
    private final ConcurrentMap<String, AtmosphereResource> resources = new ConcurrentHashMap<String, AtmosphereResource>();
    private BroadcasterFactory broadcasterFactory;

    public DefaultAtmosphereResourceFactory() {
        AtmosphereResourceFactory.updateAtmosphereResourceFactory(this);
    }
