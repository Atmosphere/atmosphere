...
public interface ApplicationConfig {
    ...
    /**
     * Disable invoking {@link org.atmosphere.cpr.AtmosphereHandler#onStateChange(org.atmosphere.cpr.AtmosphereResourceEvent)}
    ...
    /**
     * The maximum time, in milliseconds, a connection gets idle or when the WIFI disconnection wasn't detected by the
     * underlying container. This property works with the
     ...
     * {@link org.atmosphere.interceptor.AtmosphereResourceLifecycleInterceptor} is used.
     * <p/>
     * Default: "GET"<br>
     ...
     * are used by the {@link DefaultBroadcaster}'s Thread Pool.
     * See also {@link #BROADCASTER_ASYNC_WRITE_THREADPOOL_MAXSIZE}
     * and {@link #BROADCASTER_MESSAGE_PROCESSING_THREADPOOL_MAXSIZE}
     * <p/>
    ...
    /**
     * Wait X milliseconds before considering the {@link AtmosphereResource} closed. This is useful when
