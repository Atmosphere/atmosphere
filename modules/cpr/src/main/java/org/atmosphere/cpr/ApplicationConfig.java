...
public interface ApplicationConfig {
    ...
    /**
     * Tell Atmosphere to not write the no-cache header. Default: false, e.g Atmosphere will write them.
     * <p></p>
     * Default: false
    ...
    /**
     * Tell Atmosphere to not write the access-control header. Default: false, e.g Atmosphere will write them.
     * <p></p>
     * Default: false
    ...
    /**
     * A request attribute used to tell {@link AsyncSupport} implementation to keep alive the connection or not. Default: to delegate the talk to the underlying WebServer.
     * <p></p>
