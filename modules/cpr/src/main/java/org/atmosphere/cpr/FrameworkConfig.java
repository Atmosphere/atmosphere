...
public interface FrameworkConfig {
    ...
    /**
     * A request attribute used to lookup the {@link AtmosphereServlet}. This attribute is for
     * framework integrators and not recommend for normal applications.
     */
    String ATMOSPHERE_SERVLET = "org.atmosphere.cpr.AtmosphereServlet";
    /**
     * A request attribute used to lookup the {@link AtmosphereResource}. This attribute is for
     * framework integrators and not recommend for normal applications.
     */
    String ATMOSPHERE_RESOURCE = AtmosphereResource.class.getName();
    /**
     * A request attribute used to lookup the {@link AtmosphereResource} created by an external
     * component and injected inside the {@link AsynchronousProcessor}.
     */
    ...
    /**
     * A request attribute used to lookup the {@link AtmosphereHandler}. This attribute is for
     * framework integrator and not recommend for normal application.
     */
