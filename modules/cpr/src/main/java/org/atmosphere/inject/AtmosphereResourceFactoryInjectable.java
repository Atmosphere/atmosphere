...
/**
 * {@link Injectable} provider that resolves {@link AtmosphereResourceFactory} instances
...
public class AtmosphereResourceFactoryInjectable implements Injectable<AtmosphereResourceFactory> {
    ...
    public boolean supportedType(Type t) {
        return t instanceof Class<?> c && AtmosphereResourceFactory.class.isAssignableFrom(c);
    }
