 ...
 */
public class AtmosphereConfigReaderOld {

    private static final Logger logger = LoggerFactory.getLogger(AtmosphereConfigReaderOld.class);
     ...
     * @param stream
     */
    public AtmosphereConfigReaderOld(InputStream stream) {
