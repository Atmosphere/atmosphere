            ...
            try {
                ...
                if (message instanceof List) {
                    for (Object s : (List<Object>) message) {
                        resource.getSerializer().write(event.getResource().getResponse().getOutputStream(), s);
                    }
                }  else {
                    resource.getSerializer().write(event.getResource().getResponse().getOutputStream(), message);
                }
            } catch (Throwable ex) {
