...
public interface InvokationOrder {
    ...
    PRIORITY AFTER_DEFAULT = PRIORITY.AFTER_DEFAULT;
    PRIORITY BEFORE_DEFAULT = PRIORITY.BEFORE_DEFAULT;
    PRIORITY FIRST_BEFORE_DEFAULT = PRIORITY.FIRST_BEFORE_DEFAULT;
