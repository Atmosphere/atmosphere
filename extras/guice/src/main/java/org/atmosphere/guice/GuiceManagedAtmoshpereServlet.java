 ...
 */
@Singleton
public class GuiceManagedAtmoshpereServlet extends AtmosphereServlet {

    public static final String JERSEY_PROPERTIES = GuiceManagedAtmoshpereServlet.class.getName() + ".properties";
