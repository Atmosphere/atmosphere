...
public class AtmosphereWebAppAdapter extends WebAppAdapter {
    ...
    public AtmosphereWebAppAdapter(String root, String context, WebApp webApp,
                                   ClassLoader webAppCL, WebApp webdefault) {
        super(root, context, webApp, webAppCL, webdefault);
    }
    ...
    protected ServletAdapter createServletAdapter(
        ...
        adapter.setServletPath(getServletPath(servletUrlPattern));
        return adapter;
    }
